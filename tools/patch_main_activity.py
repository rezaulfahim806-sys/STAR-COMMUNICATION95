...
print('Legacy Add Customer override removed.' if n else 'Legacy Add Customer override already absent; continuing.')
s=s.replace('Total Left Client', '＋ Add New Customer')
pattern=r'onclick=\\+"?go\\(\\+\\\\\\x27customers\\+\\\\\\x27,\\{filter:\\\\\x27inactive\\\\\\x27\\}\\)\\+"?'
s,n2=re.subn(pattern, 'onclick=\\"addCustomer()\\"', s, count=1)
print('Dashboard Add Customer click replacements:', n2)
...
print('MainActivity patch applied successfully.')
